...
module.exports = {
  ...
  appIndexJs: resolveModule(resolveApp, 'src/pages/Popup/index'),
  appOptionsJs: resolveModule(resolveApp, 'src/pages/Options/index'),
  appBackgroundJs: resolveModule(resolveApp, 'src/scripts/background/index'),
  appContentScriptJs: resolveModule(resolveApp, 'src/scripts/content/index'),
